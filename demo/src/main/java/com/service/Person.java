...
public class Person {
  ...
  */ 
  ...
  private Person() { //constructor requerido for neo4j
    // Empty constructor required as of Neo4j API 2.0.5
  };

  public Person(String name, String UserName, String Password, HashSet<Quality> has, HashSet<Quality> likes, Place location)  {
    this.name = name;
